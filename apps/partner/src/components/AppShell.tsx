...
export function AppShell() {
  ...
  // Workspace (dashboard, bookings) is only for approved partners. Anyone
  // still PENDING / REJECTED gets bounced to the application screen.
            ...
            <BreadcrumbList>
              <BreadcrumbItem className="hidden md:block">
                <BreadcrumbLink asChild>
                  <Link to="/dashboard">Tiglemp Partner</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
