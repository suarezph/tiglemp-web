...
/**
 * Permission utilities for admin app.
 *
 ...
 * answer "can the signed-in admin do X" without each caller having to fetch
 * `/auth/me` themselves. Cached + deduped via TanStack Query.
 *
 * NOTE: these are intentionally NOT wired into UI gating yet; they're here as
 * the building blocks for future role-aware screens.
 */
 ...
 * signed out). Use this when you want to read flags like `isSuperAdmin`
 * or `isPartnerRoot` without juggling the query state.
 */
